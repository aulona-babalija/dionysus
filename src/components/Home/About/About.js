  ...
  return (
    <div id="about" className="about-component p-4 ps-5 pe-5 pb-5" data-aos="fade-up">
      ...
      <p className="fst-italic text-center mt-5 fw-bold">
        ...
        craftsmanship, designed to take culinary arts to the next level.
      </p>
      <div className="content d-flex align-items-center justify-content-around mt-5 mb-5">
        <div className="left-text flex-2" data-aos="fade-right">
          ...
          <p>
            ...
            chatbot, Dionysus does not communicate with guests or staff. Instead, it
            functions as a precision tool, enhancing culinary creativity
            and ensuring each dish and wine selection aligns with the highest culinary standards.
          </p>
        </div>
        ...
        <div className="right-text flex-2 text-end" data-aos="fade-left">
          ...
          <p>
            Dionysus, named after the Greek god of wine and
            celebration, embodies the fusion of tradition and innovation.
            Dionysus enhances the art of fine dining through AI-driven precision and customizability.
            It is a behind-the-scenes assistant, designed exclusively for
